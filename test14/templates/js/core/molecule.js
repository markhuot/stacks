...
$(document).on('render.stacks', '.molecule', function(e) {
	...
	$(this).attr('data-count', $(this).find('.atom').size());
	e.stopPropagation();
});

$(document).on('render.stacks', '.molecule > .add', function(e) {
	$(this).append('<li><a href="#" data-type="heading">Heading</a></li>');
	$(this).append('<li><a href="#" data-type="paragraph">Paragraph</a></li>');
	$(this).append('<li><a href="#" data-type="blockquote">Blockquote</a></li>');
	$(this).append('<li><a href="#" data-type="list">List</a></li>');
	$(this).append('<li><a href="#" data-type="image">Image</a></li>');
	$(this).append('<li><a href="#" data-type="rule">Rule</a></li>');
	e.stopPropagation();
});
